...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <span class="navbar-brand">TechMada - RH</span>
...
<main class="container py-5">
    <div class="alert alert-info" role="alert">
        <h4 class="alert-heading">Bienvenue RH!</h4>
        <p>Vous êtes connecté(e) en tant que Responsable RH. Vous avez accès à la gestion des congés et des employés.</p>
        <hr>
        <p class="mb-0">Vos permissions: Gestion des congés, Gestion des employés, Rapports RH.</p>
    </div>
